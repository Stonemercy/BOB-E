...
module.exports = {
	...
	async execute(interaction) {
		...
		if (!currentGuild.shop_channel_id) {
			...
			return interaction.reply(`You've sold: **${item}** for ${currentGuild.shop_currency} ${guildItem.cost * 0.75}.\nNew balance: ${currentGuild.shop_currency} ${currentUser.balance}`);
